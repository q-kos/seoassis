...
Веб-приложение для SEO-анализа сайтов. Пользователь вводит URL и получает подробный отчёт по техническим и контентным параметрам страницы. Итоговый проект курса по веб-разработке.

## Возможности

- **SEO-аудит** — анализ страницы через Claude AI: title, description, заголовки, Open Graph, Schema.org, canonical, robots и другие параметры. Оценка от 0 до 100 с разбивкой на критические ошибки, предупреждения и норму
- **Редактор мета-тегов** — проверка длины title и description, превью в поисковой выдаче
- **Сканер сайта** — обход всех страниц сайта, проверка наличия и длины мета-тегов, выгрузка в CSV
- **Анализ мета** — извлечение title и description с любой страницы + генерация улучшенных вариантов через AI
