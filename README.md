...
- **SEO-аудит** — анализ страницы через Claude AI: title, description, заголовки, Open Graph, Schema.org, canonical, robots и другие параметры. Оценка от 0 до 100 с разбивкой на критические ошибки, предупреждения и норму<br><br>
![SEO-аудит](/image/4.png)<br><br>
- **Редактор мета-тегов** — проверка длины title и description, превью в поисковой выдаче<br><br>
![Редактор мета-тегов](/image/1.png)<br><br>
- **Сканер сайта** — обход всех страниц сайта, проверка наличия и длины мета-тегов, выгрузка в CSV<br><br>
![Сканер сайта](/image/2.png)<br><br>
- **Анализ мета** — извлечение title и description с любой страницы + генерация улучшенных вариантов через AI<br><br>
